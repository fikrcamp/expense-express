...
app.post("/expense",(req,res)=>{
    // "ternery if" that finds the last id of expense list , If list is empty the default id would be 1
     let id= expense[expense.length-1].id+1 ? id= expense[expense.length-1].id+1 : 1;
...
app.put("/expense/:id",(req,res)=>{
    const index = expense.findIndex(expense=> expense.amount == req.params.id)
    ...
    expense.splice(index,1,updatedExpense)
